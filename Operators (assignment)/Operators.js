...
Disse tre betingelser indsættes i en funktion med parameret "year",
...
function checkLeapYear(year) {
    ...
    if ((0 == year % 4) && (0 != year % 100) || (0 == year % 400)) {
        console.log(year + ' er korrekt');
    } else {
        console.log(year + ' er desværre forkert');
    }
}
